...
def teacher_dashboard():
  ...
  tab1, tab2, tab3 = st.columns(3, vertical_alignment='center', gap="medium")
  with tab1:
...
def teacher_screen_login():
      ...
      teacher_username = st.text_input("Enter username", placeholder='adityaanand')
...
def teacher_screen_register():
        ...
        teacher_username = st.text_input("Enter username", placeholder='adityaanand')
        teacher_name = st.text_input("Enter name", placeholder='Aditya Anand')
        teacher_pass = st.text_input("Enter password", type='password', placeholder='Enter password')
