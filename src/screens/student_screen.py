...
def student_dashboard():
  ...
  for i, sub_node in enumerate(subjects):
    ...
    def unenroll_button():
      if st.button('Unenroll form this course', type= 'tertiary', width='stretch', icon=':material/delete_forever:'):
        unenroll_student_to_subject(student_id, sid)
        st.toast(f"Unenrolled form {sub['name']} successfully")
        st.rerun()
...
def student_screen():
  ...
  if show_registration:
    with st.container(border=True):
      ...
      new_name = st.text_input("Enter your name", placeholder='E.g. Aditya Anand')
      ...
      try:
        audio_data = st.audio_input('Record a short phrase like I am present, My name is Nikhil.')
      except Exception:
